...
left_comp_ip = '192.168.1.15'
middle_comp_ip = '192.168.1.15'
right_comp_ip = '192.168.1.15'
...
RECV_IP_PORT1 = (left_comp_ip,12000)
RECV_IP_PORT2 = (middle_comp_ip,12001)
RECV_IP_PORT3 = (right_comp_ip,12002)
...
c = Canvas(root, width=WIDTH, height=HEIGHT, background="#3bff83")
c.pack()
...
LEFT_PAD = c.create_line(LEFT_PAD_W/2, 0, LEFT_PAD_W/2, LEFT_PAD_H, width=LEFT_PAD_W, fill="#300081")
